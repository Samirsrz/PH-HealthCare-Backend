...
import { ForgotPasswordZodSchema, LoginZodSchema, PatientEmailVerifiedZodSchema, PatientRegistrationZodSchema } from "./auth.validation";
...
router.post("/reset-password",validateRequest(PatientEmailVerifiedZodSchema), AuthController.resetPassword);
