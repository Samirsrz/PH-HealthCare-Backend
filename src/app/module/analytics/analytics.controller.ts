...
const getPatientAnalytics = catchAsync(async (req: Request, res: Response) => {
    ...
    const result = await AnalyticsServices.getPatientAnalyticsDB(user);
    sendResponse(res, {
...
const getDoctorAnalytics = catchAsync(async (req: Request, res: Response) => {
    ...
    const result = await AnalyticsServices.getDoctorAnalyticsDB(user);
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
...
const getAdminAnalytics = catchAsync(async (req: Request, res: Response) => {
    const result = await AnalyticsServices.getAdminAnalyticsDB();
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
